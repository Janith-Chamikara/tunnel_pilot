...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'motor_test_dynamic_thrust_guided = tunnel_pilot.motor_test_dynamic_thrust_guided:main',
            'motor_test_dynamic_thrust_stabilzed = tunnel_pilot.motor_test_dynamic_thrust_stabilzed:main',
        ],
    },
)
